      ...
      <Card className="p-6 bg-white border border-gray-200 shadow-xl rounded-3xl">
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <Card
              className="p-4 bg-gradient-to-r from-pink-200 to-rose-200 border border-pink-300/50 shadow-sm rounded-2xl">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div
                    className="w-8 h-8 bg-black/10 rounded-lg flex items-center justify-center">
                    <Wallet className="w-4 h-4 text-gray-700" />
                      ...
                      <span className = "font-medium text-gray-800"> Funding < /span>
                        ...
                        <span className = "font-semibold text-gray-800"> $243, 940.03 < /span>
                          ...
                          <Card
                            className = "p-4 bg-gradient-to-r from-purple-200 to-indigo-200 border border-purple-300/50 shadow-sm rounded-2xl">
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-3">
                                <div
                                  className="w-8 h-8 bg-black/10 rounded-lg flex items-center justify-center">
                                  <TrendingUp className="w-4 h-4 text-gray-700" />
                                    ...
                                    <span className = "font-medium text-gray-800"> Unified Trading < /span>
                                      ...
                                      <span className = "font-semibold text-gray-800"> $310, 495.50 < /span>
                                        ...
                                        <div
                                          className = "space-y-4 py-6 px-2 border border-gray-100 rounded-2xl bg-white">
                                                              ...
                                                              <Bitcoin className="w-4 h-4" />
                                                                <span className="font-medium"> 9.300554 BTC < /span>
                                                                  ...
                                                                  <div className = "flex gap-3">
                                                                    <Button
                                                                      className="flex-1 bg-pink-500 hover:bg-pink-600 text-white rounded-2xl h-12 gap-2 border border-pink-600">
      ...
      <Clock className="w-4 h-4 text-gray-700" />
        ...
        <div className = "space-y-1 pt-2">
          ...
          <div
            ...
            <div
              className="w-12 h-12 bg-pink-100 rounded-2xl flex items-center justify-center border border-pink-200">
                  ...
                  <h3 className="font-semibold text-gray-900"> Funding Account < /h3>
                    <p className = "text-sm text-gray-500"> Manage your funding account < /p>
                      ...
                      <div
                        className = "flex items-center gap-4 p-3 border border-gray-100 rounded-2xl hover:bg-gray-50 transition-colors">
                        <div
                          className="w-12 h-12 bg-purple-100 rounded-2xl flex items-center justify-center border border-purple-200">
